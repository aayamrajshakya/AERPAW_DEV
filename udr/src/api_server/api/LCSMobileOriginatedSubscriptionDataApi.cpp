...
void LCSMobileOriginatedSubscriptionDataApi::init() {
  setupRoutes();
}

void LCSMobileOriginatedSubscriptionDataApi::setupRoutes() {
  ...
  router->addCustomHandler(Routes::bind(
      &LCSMobileOriginatedSubscriptionDataApi::
          lcs_mobile_originated_subscription_data_api_default_handler,
      this));
}

void LCSMobileOriginatedSubscriptionDataApi::query_lcs_mo_data_handler(
...
void LCSMobileOriginatedSubscriptionDataApi::
    lcs_mobile_originated_subscription_data_api_default_handler(
