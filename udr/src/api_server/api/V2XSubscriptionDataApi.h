 ...
 */
/*
 * V2XSubscriptionDataApi.h
 *
 *
 */

#ifndef V2XSubscriptionDataApi_H_
#define V2XSubscriptionDataApi_H_
...
class V2XSubscriptionDataApi {
 public:
  V2XSubscriptionDataApi(std::shared_ptr<Pistache::Rest::Router>);
 ...
 private:
  ...
  void query_v2x_data_handler(
      const Pistache::Rest::Request& request,
      Pistache::Http::ResponseWriter response);
  void v2_x_subscription_data_api_default_handler(
      const Pistache::Rest::Request& request,
      Pistache::Http::ResponseWriter response);
